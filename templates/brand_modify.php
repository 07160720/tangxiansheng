...
<div id="pagehead" style="width: 100%;position: fixed; top: 0px;background:#DDEEF2;padding: 12px;border-bottom: 2px solid #BBDDE5; ">
	...
	<span style="font-size: 13px;color: gray;" >修改品牌</span>
</div>
<!--当前操作  -->
      ...
      <form enctype="multipart/form-data" action="./brand.php" method="post" name="theForm" onsubmit="return validate()" >
        ...
        ?>
          ...
          <tr>
            ...
            <td>
              	<input type="text" name="ch_name" size="50" value="<?php  echo $data[ch_name];?>"/>
          ...
          <tr>
          	...
          	<td>
          		<textarea  name="description"  style="width:80%;height:50px;resize:none;" maxlength="100" ><?php  echo $data[description];?></textarea>
