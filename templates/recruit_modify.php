...
<div id="pagehead" style="width: 100%;position: fixed; top: 0px;background:#DDEEF2;padding: 12px;border-bottom: 2px solid #BBDDE5; ">
	...
	<span style="font-size: 13px;color: gray;" >修改招聘信息</span>
</div>
<!--当前操作  -->
<!-- start client form -->
      ...
      <form enctype="multipart/form-data" action="recruit.php" method="post" name="theForm" onsubmit="return validate()" >
        ...
        ?>
          ...
          <tr >
            ...
            <td><input type="text" name="position" value="<?php echo $data['position']; ?>"  size="40" /></td>
          </tr>
          <tr >
            <td class="label" >薪资:</td>
            <td >
              <input type="text" name="salary" value="<?php echo $data['salary']; ?>" size="25" /><span class="link-span">*输入薪资如3000-5000 或者 “面议”</span> 
            </td>
          </tr>
          <tr>
            <td class="label">招聘人数:</td>
            <td><input type="text" name="quantity" value="<?php echo $data['quantity']; ?>" size="10" /></td>
          </tr>
          <tr >
            <td class="label" >工作地点:</td>
            <td >
              <input type="text" name="place"  value="<?php echo $data['place']; ?>" size="25" /> 
            </td>
          </tr>
          <tr >
            <td class="label" >更新时间:</td>
            <td >
              <input type="text" name="date"  value="<?php echo $data['date']; ?>" size="25" /> 
            </td>
          </tr>
          <tr>
          	<td class="label">职位描述:</td>
          	<td><textarea  name="description" style=" width:80%; height:200px; " ><?php echo $data['description']; ?></textarea></td>
          </tr>
          <tr>
          	<td class="label">任职资格:</td>
          	<td><textarea  name="qualification"  style=" width:80%; height:200px; "><?php echo $data['qualification']; ?></textarea></td>
          </tr>
          <tr>
          	<td class="label">薪酬待遇:</td>
          	<td><textarea  name="treatment" style=" width:80%; height:150px; "><?php echo $data['treatment']; ?></textarea></td>
          </tr>
          <tr>
          	<td class="label">联系方式:</td>
          	<td><textarea  name="contact" style=" width:80%; height:100px; "><?php echo $data['contact']; ?></textarea></td>
          </tr>
          <tr>
             <td >&nbsp;</td>
          </tr>
          <tr>
            ...
            <td>
                ...
                <input type="submit" name="save" value="  保存   "  />    
              	...
              	<input type="hidden" name="act" value="modify" /><!-- 隐藏的操作属性 -->
